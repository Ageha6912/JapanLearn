...
- release 包模拟器回归：未配置时按钮隐藏 ✓ / 配置后按钮出现 ✓ / 弹窗形态与设置弹窗一致 ✓ / 额度显示 20 次 ✓ / 发送禁用态 ✓
- versionName 1.3.1 / versionCode 26；tag v1.3.1 + GitHub Release（JapanLearn-v1.3.1.apk）https://github.com/Ageha6912/JapanLearn/releases/tag/v1.3.1
- 流式成功路径仍需用户真机验证（模拟器网络受限，坑 12）
